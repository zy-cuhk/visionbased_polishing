...
class VisonControl():
    ...
    def __init__1(self):
        ...
        self.xd_get=StructurePointXdydzdRead()
        self.xd_sub = rospy.Subscriber("/structure_xd", Float64, self.xd_get.structure_point_xd_callback)
        self.yd_sub = rospy.Subscriber("/structure_yd", Float64, self.xd_get.structure_point_yd_callback)
    ...
    def visionbased_impedancecontroller():
        self.structure_xnynan.sturucture_point_xn_buf
