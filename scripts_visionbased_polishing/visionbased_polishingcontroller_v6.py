...
"""
class VisonControl():
    def __init__(self,califilename,urdfname):
    ...
    def visionbased_impedancecontroller(self):
        ...
        structure_point_xdsr=self.xyd_get.structure_point_xd_callback
        structure_point_ydsr=self.xyd_get.structure_point_yd_callback
    ...
    def get_deta_joint_angle(self,sturucture_point_xyanow,structure_point_xyadsr,q,f):
        ...
        joint_angle=float(self.detat)*numpy.array(j_speed)
        return joint_angle
...
def main():
    ...
    visionbased_polishing=VisonControl(filename,urdfname)
