...
"""
without force control,just cartesian control with trejactory palnning in retangle,and use structure line
"""
class VisonControl():
    ...
    def get_feature_error_xyz(self,armaker_pose,xd,yd,zd):#armaker---x,y,z
        return [armaker_pose[0]-xd,(armaker_pose[1]-yd)*1,(armaker_pose[2]-zd)*0]
        ...
        try:
            ...
            if len(sturucture_point_xn)!=0 and len(sturucture_point_yn)!=0 and len(sturucture_point_an)!=0:
                ...
                if len(xd_get.sturucture_point_xd_buf)!=0 and len(xd_get.sturucture_point_xd_buf)!=0:
                    ...
                    print "xnynan",xnynan
                    print "joint speed\n", p0.get_joint_speed(xnynan, xd, yd, zd, q_now, xdot, 0 * ydot, count)
                    ...
                    detaangular = p0.get_deta_joint_angular(detat, xnynan, xd, yd, zd, q_now, xdot, 0*ydot, count)
                    print detaangular
                    print "##############################################################"
                    count += 0.5
