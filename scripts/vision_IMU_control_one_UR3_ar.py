...
####
    ...
    while not rospy.is_shutdown():
        ...
        if len(uv_get.uvlist_buf)!=0:
            ...
            # ee_disturb_vel = imuvel
            print "joint speed\n",p0.get_joint_speed(uvlist,z,desiruv,uvlist[0],q_now,ee_disturb_vel, Jacabian_joint, T_06)
            print "##############################################################"
            print "deta joint angular---"
            detaangular=p0.get_deta_joint_angular(detat,uvlist, z, desiruv, uvlist[0], q_now,ee_disturb_vel, Jacabian_joint, T_06)
            print detaangular
            print "##############################################################"
            print "joint angular----"
